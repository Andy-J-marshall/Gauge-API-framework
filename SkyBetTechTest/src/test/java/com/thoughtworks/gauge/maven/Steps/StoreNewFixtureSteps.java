...
public class StoreNewFixtureSteps {
    ...
    public void storeNewFixtureDefaultValues() throws UnirestException {
        Fixture fixtureBody = storeNewFixture.createFixtureWithDefaultData();
    ...
    public void storeNewFixtureSpecificTeams2(String homeTeamName, String awayTeamName) throws UnirestException {
        FootballFullState footballFullState = storeNewFixture.footballFullStateWithDefaults();
        footballFullState.setHomeTeam(homeTeamName);
        footballFullState.setAwayTeam(awayTeamName);
        footballFullState.setTeams(storeNewFixture.addTeamsUsingValues(homeTeamName, awayTeamName));
        FixtureStatus fixtureStatus = storeNewFixture.fixtureStatusWithDefault();
